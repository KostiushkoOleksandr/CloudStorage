...
const User = new Schema({
    ...
    avatar: {type: String},                              // аватар користувача, (пізніше додам більше інши до користувача)
    // зв'язуємо сутність користувача та файла (нажце маємо масив який має тип ObjectId, який в свою чергу посилається на сутнысть файла)
